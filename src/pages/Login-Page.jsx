        ...
        <section className="login-page w-full h-screen bg-(--bg-login) pt-20 pl-6 pr-6 pb-20 flex justify-center items-center flex-col">
            ...
            <form action="" className="w-md">
                ...
                <div className="col-password flex flex-col gap-2 mb-6 w-full">
                    ...
                    <input type="password" name="password" className="w-full h-14.5 p-4 border border-(--color-border) rounded-sm outline-none text-[16px] text-(--color-label) bg-white font-medium placeholder:pl-1" />
                </div>
                <div className="col-check flex items-center gap-2 mb-6" >
                    <span className="w-4 h-4 border border-(--color-border) rounded-xs flex justify-center items-center cursor-pointer">
                        <Check className="text-white" />
                    </span>
                    <p className="text-[14px] text-(--color-text)">Stay signed in for 30 days</p>
                </div>
                <input type="submit" value={`SIGN IN`} className="mb-6 cursor-pointer w-full h-15 bg-(--color-forget) rounded-sm text-[16px] text-white" />
            </form>
